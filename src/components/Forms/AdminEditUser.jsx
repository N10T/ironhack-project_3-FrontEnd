  ...
  return formValues.name ? (
    <div className="user-form">
      ...
      >
        ...
        <TextField id="standard-basic" label="User" size="small" disabled />
        <TextField
          required="true"
          id="outlined-basic"
          label="Name"
          ...
          <FormGroup>
            ...
            <FormControlLabel
              control={
                <Switch
                type="checkbox"
                checked={formValues.canInfo}
                />
              }
              label="Can post informations"
              name="canInfo"
            />
          </FormGroup>
        </FormControl>
        ...
        >
          ...
          <Select native defaultValue={formValues.role} name="role">
